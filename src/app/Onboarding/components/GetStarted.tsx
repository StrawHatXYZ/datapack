    ...
    render() {
        ...
        return (
            <div className="w-full max-w-lg text-black p-2">
                <h1 className="m-5 text-4xl text-center text-blue-500 font-bold">Datapack</h1>
                ...
                <p className='text-lg text-start'>
                   Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum sint officia reprehe nderit. Consectetur iusto pariatur debitis ut? Suscipit impedit voluptatum.
                </p>
               
                <br />

                <div className="mt-16">
                    <button className="w-full  bg-blue-500 hover:bg-blue-700 text-white text-lg font-semibold py-3 px-4 rounded" onClick={this.continue}>Get Started</button>
                </div>
            </div>
        )
    }
